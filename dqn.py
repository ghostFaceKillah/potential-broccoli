...
class DQN(nn.Module):
    """
    The Neural Network in python that approximates Q function.
    """
...
def get_screen():
    ...
    # Strip off edges, so we have a square image centered on cart
...
def plot_durations():
    ...
    # Take 100 epsiode averages and plot them too
...
def optimize_model():
    ...
    # We don't want to backprop through the expceted action value and volatile
